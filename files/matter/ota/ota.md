...
# 0 Command
## 0.1 OTA Requestor Join network
Kill OTA thread.
```c
ps -ef | grep "ota"
...
# 2 [ota-flow](ota-flow.md)
## [log-chip-tool](log-chip-tool.md)
## [log-chip-ota-provider-app](log-chip-ota-provider-app.md)
## [log-matter-device](log-matter-device.md)